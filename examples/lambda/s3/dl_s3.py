...
def handler(event, context):
    ...
    storage.download_file(data_bucket, train_file, os.path.join(local_dir, train_file))
    storage.download_file(data_bucket, test_file, os.path.join(local_dir, test_file))
    ...
    if start_epoch != 0:
        ...
        storage.download_file(cp_bucket, checked_file, os.path.join(local_dir, checked_file))
