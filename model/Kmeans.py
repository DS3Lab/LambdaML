...
class Kmeans:
	...
	def find_nearest_cluster(self):
		closest = closest_centroid(self.X, self.centroids)
		new_centroids_vec = move_centroids(self.X, closest, self.centroids)
		self.error = l2_dist(self.centroids, new_centroids_vec, None)
