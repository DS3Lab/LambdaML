...
class RedisOperator:
    """ This is a utility class, implementing basic functionality for interacting with Amazon ElastiCache for Redis"""

    @staticmethod
    def _get_client(host, port):
    ...
    @staticmethod
    def _hdelete_keys(client, field, keys):
    ...
    @staticmethod
    def _hget_object(client, field, key):
    ...
    @staticmethod
    def _hget_object_or_wait(client, field, key, sleep_time, time_out=60):
    ...
    def _list_keys(client, count=1000):
        ...
        try:
            response = client.scan(count=count)[1]  # match allows for the pattern of keys
            names = response
        except ClientError as e:
    ...
    @staticmethod
    def _hlist_keys(client, field, count=1000):
    ...
    @staticmethod
    def _hset_object(client, field, key, src_data):
