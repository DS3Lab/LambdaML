...
#   /home/ubuntu/anaconda3/envs/pytorch_p36/bin/python3 -u /home/ubuntu/LambdaML/ec2/cnn/cifar10_resnet50_grad_avg.py --init-method --rank $i --world-size $world_size --root /home/ubuntu/cifar10 --no-cuda &
# done
