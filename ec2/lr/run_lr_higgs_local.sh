...
# ./run_lr_higgs_local.sh 16 6250 0.01 100 172.31.41.172:24000
...
for ((i=0; i<$world_size; i++)); do
  ...
  log_file=$i"_"$1".log"
  rm -f logs/$log_file
  nohup python higgs_lr_grad_avg.py --init-method tcp://$master_ip --world-size $world_size --rank $i --root /home/ubuntu/dataset/higgs/ --no-cuda --batch-size $batch_size --learning-rate $learning_rate --epochs $epochs > logs/$log_file 2>&1 &
done
